...
public class CafeActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (!isInternetPresent) {
			...
			alert.showAlertDialog(CafeActivity.this, "Отсутствует интернет подключение",
		...
		if (gps.canGetLocation()) {
			...
			alert.showAlertDialog(CafeActivity.this, "GPS Status",
	...
	class LoadPlaces extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(CafeActivity.this);
		...
		protected String doInBackground(String... args) {
			...
			try {
				...
				// 
				String types = "cafe"; // Listing places only cafes, restaurants
				...
				public void run() {
					...
					if(status.equals("OK")){
						...
						if (nearPlaces.results != null) {
							...
							// list adapter
							ListAdapter adapter = new SimpleAdapter(CafeActivity.this, placesListItems,
					                R.layout.list_item,
						...
						// Zero results found
						alert.showAlertDialog(CafeActivity.this, "Ошибка",
